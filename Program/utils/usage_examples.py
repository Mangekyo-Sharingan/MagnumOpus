...
def example_multi_module_testing():
    ...
    config_log.log("[OK] All config tests passed")

    # Test data module
    data_log = multi_logger.get_logger("data_test")
    data_log.log("Testing data module")
    data_log.log("[OK] Data loading test passed")
    data_log.log("[OK] Data preprocessing test passed")

    # Test models module
    models_log = multi_logger.get_logger("models_test")
    models_log.log("Testing models module")
    models_log.log_list([
        "[OK] VGG16 test passed",
        "[OK] ResNet50 test passed",
        "[OK] InceptionV3 test passed"
    ], title="Model Tests:")
