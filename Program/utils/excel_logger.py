...
class ExcelLogger:
    ...
    def __init__(self, program_name, excel_file=None, log_dir=None, capture_stdout=False):
        ...
        print(f"[OK] ExcelLogger initialized for '{program_name}'")
        print(f"[OK] Logs will be saved to: {self.excel_path}")
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        # Save to Excel
        self._save_to_excel()
        print(f"[OK] Logs saved to: {self.excel_path}")
        print(f"[OK] Worksheet: '{self.program_name}'")
    ...
    def _save_to_text_fallback(self):
        ...
        print(f"[OK] Fallback: Logs saved to text file: {text_file}")
